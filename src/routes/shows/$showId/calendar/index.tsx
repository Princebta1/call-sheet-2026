...
export const Route = createFileRoute("/shows/$showId/calendar/")({
...
function ProductionCalendarPage() {
  ...
  const navigate = useNavigate({ from: "/shows/$showId/calendar" });
  ...
  const scenesQuery = useQuery(
    trpc.getScenes.queryOptions({
      ...
      location: searchParams.location.trim() !== "" ? searchParams.location : undefined,
      assignedActorIds: searchParams.actorIds.length > 0 ? searchParams.actorIds : undefined,
    })
  );
  ...
  const updateSceneMutation = useMutation(
    trpc.updateScene.mutationOptions({
      ...
      onError: (error) => {
        toast.error(error.message || "Failed to reschedule scene");
      },
    })
  );
    ...
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-gray-400">Schedule and manage scenes for this production</p>
        </div>
        {canManageScenes && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3">
          {scenesQuery.isLoading || usersQuery.isLoading ? (
